...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python3 coco2.py train --dataset=../../masks/ --model=coco
...
class CocoDataset(utils.Dataset):
    def load_coco(self, dataset_dir, subset, class_ids=None, return_coco=False):
        ...
        """
        coco = COCO("{}/annotations/{}_annotation.json".format(dataset_dir, subset))
    ...
    def load_mask(self, image_id):
        ...
        for annotation in annotations:
            ...
            if class_id:
                # print("READING IMAGE: ", annotation['image_id'])
                # print("IMG INFO", image_info["height"])
